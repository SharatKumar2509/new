  ...
  return (
    <>
      ...
      <div style={{ backgroundColor: '#02b5ac' }} className={`bg-#02b5ac! gap-5 sm:gap-10 min-h-screen flex-col shadow-md p-4  flex  md:flex-row-reverse`}>
        <div className="w-full my-auto">
          <img className='w-full ' style={{width: '100%', height: 'auto', aspectRatio: '14/9', objectFit: 'cover', borderRadius: '15px'}} src={"https://www.overninja.com/uploads/portfolio/" + item.project_image_6} alt={item.client} />
        </div>
        <div className={`w-full text-white my-auto`}>
