...
const CaseStudies = () => {
  ...
  return (
    <section className="overflow-hidden font-custom">
       <HeroMain heading={"Dive into case studies that highlight our expertise and commitment"} btn={"Get a free quote"} clip={caseStudyheroclip} bg={{background: 'linear-gradient(to right, #061161, #780206)'}} />
        {
