...
const WhatWeDo = () => {
  ...
  return (
    <section className="overflow-hidden">
        <HeroMain heading={"We pour our heart and soul into crafting powerful campaigns "} btn={"Get a free quote"} clip={service} bg={{background: 'linear-gradient(to right, #0F2027, #203A43, #2C5364)'}} />
