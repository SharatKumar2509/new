...
const Home = () => {
  ...
  return (
    ...
    <HeroMain heading={"Boost your sales to new heights with our digital marketing services"} btn={"Get a free quote"} clip={clip1} bg={{background: 'linear-gradient(to right, #333333, #dd1818)'}} />
